    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.POST, "/api/medical-records/{patientId}/add-observations").hasAnyAuthority("ADMIN", "HEALTH_PROFESSIONAL")
                .requestMatchers(HttpMethod.POST, "/api/medical-records/{patientId}/add-surgery-observations").hasAnyAuthority("ADMIN", "HEALTH_PROFESSIONAL")
                ...
                .requestMatchers(HttpMethod.PUT, "/api/medical-records/{patientId}/update-observations").hasAnyAuthority("ADMIN", "HEALTH_PROFESSIONAL")
                .requestMatchers(HttpMethod.PUT, "/api/medical-records/{patientId}/update-surgery-observations").hasAnyAuthority("ADMIN", "HEALTH_PROFESSIONAL")
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/medical-records/{patientId}/remove-observations").hasAnyAuthority("ADMIN", "HEALTH_PROFESSIONAL")
                .requestMatchers(HttpMethod.DELETE, "/api/medical-records/{patientId}/remove-surgery-observations").hasAnyAuthority("ADMIN", "HEALTH_PROFESSIONAL")
